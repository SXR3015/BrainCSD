...
def parse_opts():
    ...
    parser.add_argument(
        '--root_path', default=r'/data1/sxr/Unified_model/code/fMRI_foundation'
    ...
    parser.add_argument(
        '--batch_size', default=450, type=int, help='Batch Size')
    # parser.add_argument('--temperature', default=0.07, type=float,
    #                     help='softmax temperature (default: 0.07)')
    parser.add_argument('--n_views', default=512, type=int, metavar='N',
                        help='Number of views for contrastive learning training.')
    parser.add_argument(
        '--n_epochs', default=500, type=int, help='Number of total epochs to run')
    # parser.add_argument(
