...
def parse_opts():
    ...
    parser.add_argument(
        '--root_path', default=r'/data1/sxr/Unified_model/code/dMRI_foundation'
    ...
    parser.add_argument(
        '--resume_path', default='', type=str, help='path of pretrained classifier weight')
    parser.add_argument(
    ...
    parser.add_argument(
        '--refine', default=False, type=bool, help='Wide resnet k')
    parser.add_argument(
        '--manual_seed', default=1680, type=int, help='Manually set random seed')#1024
    parser.add_argument(
        '--learning_rate', default=1e-3, type=float, help= 'Initial learning rate')#学习率
    parser.add_argument(
    ...
    parser.add_argument(
        '--batch_size', default=380, type=int, help='Batch Size')
    # parser.add_argument('--temperature', default=0.07, type=float,
    #                     help='softmax temperature (default: 0.07)')
    parser.add_argument('--n_views', default=512, type=int, metavar='N',
                        help='Number of views for contrastive learning training.')
    parser.add_argument(
        '--n_epochs', default=1000, type=int, help='Number of total epochs to run')
    # parser.add_argument(
    ...
    parser.add_argument("--dim_refine", type=int, default=512)
    parser.add_argument("--depth_refine", type=int, default=16)
    ...
    return args
'''
same structure, do not fit for dMRI_foundation
'''