...
def parse_opts():
    ...
    parser.add_argument(
        '--root_path', default=r'/data1/sxr/Unified_model/code/FC_SC_Refined'
    ...
    parser.add_argument(
        '--pretrain_refine_path', default='/data1/sxr/Unified_model/code/FC_SC_Refined/results/refine/weights_epoch400'
                                          '/weights_epoch400.pth', type=str, help='path of pretrained refined foundation weight')
    parser.add_argument(
        '--pretrain_raw_path', default='/data1/sxr/Unified_model/code/FC_SC_gen/results/refine/weights_epoch20/weights_epoch20.pth',
                                       type=str, help='path of pretrained raw Connectcome gen weight')
    parser.add_argument(
    ...
    '''
    weight decay can not be two large
    '''
    parser.add_argument(
    ...
    parser.add_argument("--dim_raw", type=int, default=256)
    parser.add_argument("--depth_raw", type=int, default=4)
    parser.add_argument("--mlpdim_raw", type=int, default=512)
    parser.add_argument("--dim_refine", type=int, default=256)
    parser.add_argument("--depth_refine", type=int, default=4)
    parser.add_argument("--mlp_dim_refine", type=int, default=64)
    parser.add_argument("--patch_size_refine", type=int, default=32)
